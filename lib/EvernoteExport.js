(function() {
  ...
  EvernoteExport = (function() {
    ...
    EvernoteExport.prototype._exportAttachments = function(exportDirectory, note) {
      var attachment, enex, hash, path, _ref, _results;
      enex = this;
      ...
      for (hash in _ref) {
        ...
        _results.push(fs.writeFile(path, attachment.data, function(err) {
          if (err) {
            throw err;
          }
        }));
    ...
    EvernoteExport.prototype._exportAttachmentPath = function(exportDirectory, attachment) {
      return this._resourceDirectory(exportDirectory) + '/' + attachment.hash + '.' + attachment.extention;
    };
