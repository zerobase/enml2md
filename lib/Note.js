  ...
  Note = (function() {
    ...
    Note.prototype.loadENMLContent = function(note_content) {
      ...
      $('en-media').each(function() {
        var attachment, attachmentFileName, displayAttachmentFileName, hash, type;
        hash = $(this).attr('hash');
        type = $(this).attr('type');
        ...
        if (type.substr(0, 5) === 'image') {
          return $(this).replaceWith("<img alt=\"" + type + "\" src=\"resources/" + attachmentFileName + "\"/>");
        } else {
          return $(this).replaceWith("<a href=\"resources/" + attachmentFileName + "\">" + displayAttachmentFileName + "</a>");
        }
      });
